...
class BrushTicket(object):
    ...
    def send_mail(self, receiver_address, content):
        ...
        host = 'smtp.163.com'
        port = 25
        sender = '13271331235@163.com'  # 你的发件邮箱号码
...
if __name__ == '__main__':
    ...
    #     passengers = passengers_input.split(",")
    # 乘车日期
    from_time = '2019-01-31'#input('请输入乘车日期（例如“2018-08-08”）：')
    ...
    receiver_email = '13271331235@163.com'
